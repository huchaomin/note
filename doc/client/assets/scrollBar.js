import{r,o as l,c as a,f as e,g as o}from"./vendor.js";const b={__name:"scrollBar",setup(i){const t=[{id:"doc-title",title:"\u4FEE\u6539 scrollbar \u6837\u5F0F"}];return(s,d)=>{const n=r("doc-code"),c=r("doc-page");return l(),a(c,{desc:"\u4FEE\u6539 scrollbar \u6837\u5F0F scss \u8BED\u6CD5",toc:t},{default:e(()=>[o(n,{code:`@mixin scrollBar($width) {
  &::-webkit-scrollbar{
