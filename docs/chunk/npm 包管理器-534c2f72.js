...
#   }
# }
`,lang:"shell"}),r,v,s(e,{code:`npm install lodash # \u5F53\u524Dnode_modules \u5B50\u6587\u4EF6\u5939\u4E0B\u3001dependencies\u4E2D
npm install -g lodash #\u5168\u5C40node_modules \u5B50\u6587\u4EF6\u5939\u4E0B
npm root -g # \u5168\u5C40\u7684\u4F4D\u7F6E(C:\\Users\\hwx927218\\AppData\\Roaming\\npm\\node_modules)
`,lang:"shell"}),k,x,s(e,{code:`npm list
npm list -g # \u5168\u5C40
npm list --depth=0 # \u4EC5\u67E5\u770B\u9876\u5C42\uFF08\u4E5F\u5C31\u662Fpackage.json\u91CC\u9762\u7684\uFF09
npm list -g --depth=0 # \u4EC5\u67E5\u770B\u5168\u5C40\u9876\u5C42
npm list <package-name> # \u7279\u5B9A\u5305\u7684\u7248\u672C(\u4E5F\u9002\u7528\u4E8E\u4F9D\u8D56\u5305)
`,lang:"shell"}),b,s(e,{code:`npm view [package_name] version # \u6700\u65B0\u7248
npm view [package_name] versions # \u6240\u6709\u5386\u53F2\u7248\u672C
`,lang:"shell"}),j,f,s(e,{code:`npm install <package-name>@<version>
npm install -g <package-name>@<version>
`,lang:"shell"}),w,s(e,{code:`npm update # package.json\u4E0D\u4F1A\u6539\u53D8\uFF0Cpackage-lock.json\u53EF\u80FD\u4F1A\u6539\u53D8
npm install # \u540C\u4E0A
npm outdated # \u67E5\u770B\u54EA\u4E9B\u9876\u5C42\u5305\u6709\u66F4\u65B0
`,lang:"shell"}),y,s(e,{code:`npm install -g npm-check-updates
ncu -u
npm update # \u66F4\u63A8\u8350 rimraf node_modules,\u7136\u540Enpm install
`,lang:"shell"}),C,s(e,{code:`npm uninstall <package-name> # \u5378\u8F7D\u5305\uFF0C\u4E0D\u6539\u53D8package.json
...
`,lang:"shell"}),D,B,N,R,V,L,s(e,{code:`#  \u6211\u7535\u8111\u6CA1\u6709\u5B89\u88C5npx\u548Ccowsay
npx cowsay "\u4F60\u597D"
#  \u81EA\u52A8\u5168\u5C40\u5B89\u88C5\u548Cnpm\u76F8\u540C\u7248\u672C\u7684npx
#  \u4E0B\u8F7Dcowsay
#  \u6267\u884C\u4E0A\u9762\u7684\u547D\u4EE4
#  \u5378\u8F7Dcowsay
`,lang:"shell"}),U,s(e,{code:`npx vue create my-vue-app # \u8FD0\u884C vue CLI \u5DE5\u5177\u4EE5\u521B\u5EFA\u65B0\u7684\u5E94\u7528\u7A0B\u5E8F\u5E76\u8FD0\u884C\u5B83\u4EEC
npx create-react-app my-react-app # \u4F7F\u7528 create-react-app \u521B\u5EFA\u65B0\u7684 React \u5E94\u7528
`,lang:"shell"}),z,s(e,{code:`npx node@10 -v #v10.18.1
npx node@12 -v #v12.14.1
`,lang:"shell"}),A,s(e,{code:`npx https://gist.github.com/zkat/4bc19503fe9e9309e2bfaa2c58074d32
`,lang:"shell"})]),_:1})}}};export{F as default};
