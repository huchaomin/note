...
#    'haha'
#  ]
`,lang:"sh"}),m,e(o,{code:`node index.js haha hehe
# [haha, hehe]
node index.js haha=hehe name=joe
# [haha=hehe, name=joe]
`,lang:"sh"}),j,e(o,{code:`node index.js --haha=hehe --name=joe

const args = require('minimist')(process.argv.slice(2))
# args.name = joe
# args.haha = hehe
`,lang:"sh"}),v,f,x,b,e(o,{code:`const x = 'x'
const y = 'y'
console.log(x, y)
//  'x' 'y'
