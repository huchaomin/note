import{r as t,o,c,f as a,g as n,a8 as s}from"./vendor-5a734afa.js";const l=s("h2",{id:"1-\u5B89\u88C5husky\u548Clint-staged",class:"doc-heading"},"\u5B89\u88C5husky\u548Clint-staged",-1),h=s("h2",{id:"2--husky-pre-commit-\u6587\u4EF6\u4FEE\u6539",class:"doc-heading"},".husky\\pre-commit \u6587\u4EF6\u4FEE\u6539",-1),p=s("h2",{id:"3-\u4FEE\u6539package-json",class:"doc-heading"},"\u4FEE\u6539package.json",-1),g=s("h2",{id:"4-01\u548C04\u6700\u7EC8\u7684devdependencies-\u4EC5\u4F5C\u53C2\u8003-",class:"doc-heading"},"01\u548C04\u6700\u7EC8\u7684devDependencies(\u4EC5\u4F5C\u53C2\u8003)",-1),m={__name:"\u914D\u5408husky\u4E0Elint-staged",setup(u){const d=[{id:"doc-title",title:"eslint\u914D\u5408husky\u4E0Elint-staged"},{id:"1-\u5B89\u88C5husky\u548Clint-staged",title:"1. \u5B89\u88C5husky\u548Clint-staged"},{id:"2--husky-pre-commit-\u6587\u4EF6\u4FEE\u6539",title:"2. .husky\\pre-commit \u6587\u4EF6\u4FEE\u6539"},{id:"3-\u4FEE\u6539package-json",title:"3. \u4FEE\u6539package.json"},{id:"4-01\u548C04\u6700\u7EC8\u7684devdependencies-\u4EC5\u4F5C\u53C2\u8003-",title:"4. 01\u548C04\u6700\u7EC8\u7684devDependencies(\u4EC5\u4F5C\u53C2\u8003)"}];return(_,r)=>{const e=t("doc-code"),i=t("doc-page");return o(),c(i,{desc:"eslint\u914D\u5408husky\u4E0Elint-staged,\u4E3A\u4EE3\u7801\u6D01\u7656\u4FDD\u9A7E\u62A4\u822A",toc:d},{default:a(()=>[l,n(e,{code:`yarn add husky lint-staged -D
npx husky-init
`,lang:"shell"}),h,n(e,{code:`#!/bin/sh
. "$(dirname "$0")/_/husky.sh"

npx lint-staged
`,lang:"shell"}),p,n(e,{code:`"lint-staged": {
  "*.{js,jsx,vue}": [
    "eslint"
  ]
},
